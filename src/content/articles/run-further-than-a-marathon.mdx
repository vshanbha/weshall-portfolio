...
heroCaption: "Forrest running through monument valley. Sorry can't use an image of the original Forrest Gump due to possible IP issues, so here is an AI generated one"
---

import { Image } from 'astro:assets';
import sufiyaImage from './sufiya-sufi-et-hero.jpg';
...
<Image src={sufiyaImage} alt="Sufiya Sufi running in Kashmir" widths={[640, 960, 1280]} sizes="(max-width: 768px) 100vw, 768px" class="w-full rounded-lg" />
