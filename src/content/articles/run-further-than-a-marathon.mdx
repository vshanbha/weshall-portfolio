...
import forrestImage from './forrest_monument_valley.png';
import sufiyaImage from './sufiya-sufi-et-hero.jpg';

# Run Further Than a Marathon

<Image src={forrestImage} alt="AI generated image of Forrest Gump running through Monument Valley" class="w-full rounded-lg" />

<figcaption class="text-sm text-foreground-muted mt-2 italic">
...
<Image src={sufiyaImage} alt="Sufiya Sufi running" class="w-full rounded-lg" />
