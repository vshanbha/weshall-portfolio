...
import heroImage from './oops-i-deleted-it-again-hero.png';

# Oops, I Deleted It Again

<Image src={heroImage} alt="AI-generated illustration of an agent deleting files" class="w-full rounded-lg" />
