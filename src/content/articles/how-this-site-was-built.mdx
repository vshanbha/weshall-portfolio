...
import desktopImage from './weshall-pagespeed-desktop.png';
import mobileImage from './weshall-pagespeed-mobile.png';
...
<Image src={desktopImage} alt="PageSpeed results on desktop showing 100 Performance score" class="w-full rounded-lg" />

<Image src={mobileImage} alt="PageSpeed results on mobile showing 100 Performance score" class="w-full rounded-lg" />
