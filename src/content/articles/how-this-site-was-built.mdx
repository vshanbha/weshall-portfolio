...
<p class="text-sm text-foreground-muted mt-2 italic text-center">Desktop scorecard</p>
...
<p class="text-sm text-foreground-muted mt-2 italic text-center">Mobile scorecard</p>
