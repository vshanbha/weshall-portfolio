...
import desktopPageSpeed from './weshall-pagespeed-desktop.png';
import mobilePageSpeed from './weshall-pagespeed-mobile.png';
...
<Image src={desktopPageSpeed} alt="PageSpeed results on desktop showing 100 Performance score" widths={[640, 960, 1280]} sizes="(max-width: 768px) 100vw, 768px" class="w-full rounded-lg" />
<p class="text-sm text-foreground-muted mt-2 italic text-center">Desktop scorecard — 100 Performance, 100 Accessibility, 100 Best Practices, 100 SEO</p>

<Image src={mobilePageSpeed} alt="PageSpeed results on mobile showing performance metrics" widths={[640, 960, 1280]} sizes="(max-width: 768px) 100vw, 768px" class="w-full rounded-lg" />
<p class="text-sm text-foreground-muted mt-2 italic text-center">Mobile scorecard — 100 Performance, 100 Accessibility, 100 Best Practices, 100 SEO</p>
