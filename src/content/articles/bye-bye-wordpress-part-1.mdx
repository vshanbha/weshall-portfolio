...
import heroImage from './bye-bye-wordpress-part-1.webp';

# Bye Bye WordPress (Part 1)

<Image src={heroImage} alt="PageSpeed Insights score of 100 for the Jekyll starter template" class="w-full rounded-lg" />
